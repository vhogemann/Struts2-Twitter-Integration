...
@XmlRootElement(name = "ListDomainsResult", namespace = "http://sdb.amazonaws.com/doc/2009-04-15/")
public class ListDomainsResult {

    @XmlElement(name = "DomainName", namespace = "http://sdb.amazonaws.com/doc/2009-04-15/")
