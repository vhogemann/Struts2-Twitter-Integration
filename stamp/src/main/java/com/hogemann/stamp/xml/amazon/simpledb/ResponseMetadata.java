...
@XmlRootElement(name = "ResponseMetadata", namespace = "http://sdb.amazonaws.com/doc/2009-04-15/")
public class ResponseMetadata {

    @XmlElement(name = "RequestId", namespace = "http://sdb.amazonaws.com/doc/2009-04-15/", required = true)
    protected String requestId;
    @XmlElement(name = "BoxUsage", namespace = "http://sdb.amazonaws.com/doc/2009-04-15/", required = true)
